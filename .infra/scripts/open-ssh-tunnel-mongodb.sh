...
function open_ssh_tunnel() {
  ...
  echo "mongodb://{{ vault[env_type].PILOTAGE_MONGODB_USER }}:{{ vault[env_type].PILOTAGE_MONGODB_USER_PASSWORD }}@127.0.0.1:${local_port}/{{ vault.DB_NAME }}?authSource=admin&retryWrites=true&w=majority"
