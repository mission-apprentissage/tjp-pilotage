    ...
    .as(
      kdb
        ...
        .select([
          ...
          "travauxAmenagementParEtablissement",
          "travauxAmenagementReseaux",
          "travauxAmenagementReseauxDescription",
          "achatEquipement",
          "achatEquipementDescription",
          "coutEquipement",
          "equipementPrecisions",
        ...
        .union(
          kdb
            ...
            .select([
              ...
              "discipline1FormationRH",
              "discipline2FormationRH",
              sql<boolean>`null`.as("amiCmaValideEnCours"),
              ...
              sql<boolean>`null`.as("travauxAmenagementParEtablissement"),
              sql<boolean>`null`.as("travauxAmenagementReseaux"),
              sql<string>`null`.as("travauxAmenagementReseauxDescription"),
              sql<boolean>`null`.as("achatEquipement"),
              sql<string>`null`.as("achatEquipementDescription"),
              sql<number>`null`.as("coutEquipement"),
              sql<string>`null`.as("equipementPrecisions"),
...
export const down = async (db: Kysely<unknown>) => {
  ...
  await db.schema
    .dropIndex("latestDemandeIntentionView_index")
    .ifExists()
    .execute();
