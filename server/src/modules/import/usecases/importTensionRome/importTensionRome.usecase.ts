...
export const importTensionRome = async () => {
  ...
  await deleteTension();
  console.log(
    "Import des données de tension depuis les fichiers à la maille nationale\n"
  );
  await importTensionRomeNational();
  console.log(
    "Import des données de tension depuis les fichiers à la maille régionale\n"
  );
  await importTensionRomeRegion();
  console.log(
    "Import des données de tension depuis les fichiers à la maille départementale\n"
  );
