...
import type { getFormationSchema } from "@/modules/data/usecases/getFormation/getFormation.schema";
import type { Server } from "@/server/server.js";
import createServer from "@/server/server.js";

usePg();

type Response = z.infer<(typeof getFormationSchema.response)[200]>;
