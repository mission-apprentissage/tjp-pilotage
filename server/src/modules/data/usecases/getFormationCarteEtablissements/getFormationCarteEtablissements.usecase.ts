...
import { Params, QueryFilters } from "./getFormationCarteEtablissements.schema";
...
export const getFormationCarteEtablissementsUsecase =
  getFormationCarteEtablissementsFactory();
