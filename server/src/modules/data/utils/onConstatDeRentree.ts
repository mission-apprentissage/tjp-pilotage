...
export const genericOnConstatRentree = ({
  ...
  expressionBuilder<DB, keyof DB>()
    ...
    .leftJoin("positionFormationRegionaleQuadrant", (join) =>
      join.on((eb) =>
        eb.and([
          eb(eb.ref("positionFormationRegionaleQuadrant.cfd"), "=", eb.ref("dataFormation.cfd")),
          eb(eb.ref("positionFormationRegionaleQuadrant.codeDispositif"), "=", eb.ref("constatRentree.codeDispositif")),
