...
declare module 'zapatos/schema' {
  ...
  export namespace familleMetier {
    ...
    export interface Updatable {
      ...
      * - `NOT NULL`, no default
      */
      cfdSpecialite?: string | db.Parameter<string> | db.SQLFragment | db.SQLFragment<any, string | db.Parameter<string> | db.SQLFragment>;
    }
  ...
  export namespace indicateurSortie {
    ...
    export interface Selectable {
      ...
      */
      ...
      /**
      * **indicateurSortie.nbInsertion12mois**
      * - `int4` in database
      * - Nullable, no default
      */
      nbInsertion12mois: number | null;
      /**
      * **indicateurSortie.nbInsertion24mois**
      * - `int4` in database
      * - Nullable, no default
      */
    ...
    export interface Whereable {
      ...
      * - Nullable, no default
      */
      nbInsertion12mois?: number | db.Parameter<number> | db.SQLFragment | db.ParentColumn | db.SQLFragment<any, number | db.Parameter<number> | db.SQLFragment | db.ParentColumn>;
      /**
      * **indicateurSortie.nbInsertion24mois**
      * - `int4` in database
      * - Nullable, no default
      */
      nbInsertion24mois?: number | db.Parameter<number> | db.SQLFragment | db.ParentColumn | db.SQLFragment<any, number | db.Parameter<number> | db.SQLFragment | db.ParentColumn>;
    }
    export interface Insertable {
      /**
      * **indicateurSortie.formationEtablissementId**
      ...
      * - Nullable, no default
      */
      nbInsertion12mois?: number | db.Parameter<number> | null | db.DefaultType | db.SQLFragment;
      /**
      * **indicateurSortie.nbInsertion24mois**
      * - `int4` in database
      * - Nullable, no default
      */
      nbInsertion24mois?: number | db.Parameter<number> | null | db.DefaultType | db.SQLFragment;
    }
    export interface Updatable {
      /**
      * **indicateurSortie.formationEtablissementId**
      ...
      * - Nullable, no default
      */
      nbInsertion12mois?: number | db.Parameter<number> | null | db.DefaultType | db.SQLFragment | db.SQLFragment<any, number | db.Parameter<number> | null | db.DefaultType | db.SQLFragment>;
      /**
      * **indicateurSortie.nbInsertion24mois**
      * - `int4` in database
      * - Nullable, no default
      */
      nbInsertion24mois?: number | db.Parameter<number> | null | db.DefaultType | db.SQLFragment | db.SQLFragment<any, number | db.Parameter<number> | null | db.DefaultType | db.SQLFragment>;
    }
   ...
   * - Table in database
   */
  export namespace kysely_migration {
    export type Table = 'kysely_migration';
    export interface Selectable {
      /**
    ...
    export type UniqueIndex = 'kysely_migration_pkey';
    export type Column = keyof Selectable;
    export type OnlyCols<T extends readonly Column[]> = Pick<Selectable, T[number]>;
    export type SQLExpression = Table | db.ColumnNames<Updatable | (keyof Updatable)[]> | db.ColumnValues<Updatable> | Whereable | Column | db.ParentColumn | db.GenericSQLExpression;
    export type SQL = SQLExpression | SQLExpression[];
   ...
   * - Table in database
   */
  export namespace kysely_migration_lock {
    export type Table = 'kysely_migration_lock';
    export interface Selectable {
      /**
      ...
      */
      id: string;
      /**
      * **kysely_migration_lock.is_locked**
      * - `int4` in database
      * - `NOT NULL`, default: `0`
      */
      is_locked: number;
    ...
    export interface Insertable {
      ...
      * - `NOT NULL`, default: `0`
      */
      is_locked?: number | db.Parameter<number> | db.DefaultType | db.SQLFragment;
    }
    export interface Updatable {
      /**
      * **kysely_migration_lock.id**
      ...
      * - `NOT NULL`, default: `0`
      */
      is_locked?: number | db.Parameter<number> | db.DefaultType | db.SQLFragment | db.SQLFragment<any, number | db.Parameter<number> | db.DefaultType | db.SQLFragment>;
    }
    export type UniqueIndex = 'kysely_migration_lock_pkey';
    export type Column = keyof Selectable;
    export type OnlyCols<T extends readonly Column[]> = Pick<Selectable, T[number]>;
    export type SQLExpression = Table | db.ColumnNames<Updatable | (keyof Updatable)[]> | db.ColumnValues<Updatable> | Whereable | Column | db.ParentColumn | db.GenericSQLExpression;
    export type SQL = SQLExpression | SQLExpression[];
  ...
  export namespace rawData {
    ...
    export interface Selectable {
      ...
      * **rawData.id**
      * - `uuid` in database
      * - Nullable, default: `uuid_generate_v4()`
      */
      id: string | null;
    }
    export interface JSONSelectable {
  ...
  export type SelectableForTable<T extends Table> = {
    ...
    "kysely_migration": kysely_migration.Selectable;
    "kysely_migration_lock": kysely_migration_lock.Selectable;
  ...
  export type JSONSelectableForTable<T extends Table> = {
    ...
    "kysely_migration": kysely_migration.JSONSelectable;
    "kysely_migration_lock": kysely_migration_lock.JSONSelectable;
  ...
  export type WhereableForTable<T extends Table> = {
    ...
    "kysely_migration": kysely_migration.Whereable;
    "kysely_migration_lock": kysely_migration_lock.Whereable;
  ...
  export type InsertableForTable<T extends Table> = {
    ...
    "kysely_migration": kysely_migration.Insertable;
    "kysely_migration_lock": kysely_migration_lock.Insertable;
  ...
  export type UpdatableForTable<T extends Table> = {
    ...
    "kysely_migration": kysely_migration.Updatable;
    "kysely_migration_lock": kysely_migration_lock.Updatable;
  ...
  export type UniqueIndexForTable<T extends Table> = {
    ...
    "kysely_migration": kysely_migration.UniqueIndex;
    "kysely_migration_lock": kysely_migration_lock.UniqueIndex;
  ...
  export type ColumnForTable<T extends Table> = {
    ...
    "kysely_migration": kysely_migration.Column;
    "kysely_migration_lock": kysely_migration_lock.Column;
  ...
  export type SQLForTable<T extends Table> = {
    ...
    "kysely_migration": kysely_migration.SQL;
    "kysely_migration_lock": kysely_migration_lock.SQL;
