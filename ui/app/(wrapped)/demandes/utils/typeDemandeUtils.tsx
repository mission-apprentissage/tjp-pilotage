...
export const shouldDisplayColoration = (typeDemande: TypeDemandeType, libelleFCIL?: string) => {
  if (!isTypeColoration(typeDemande)) return true;
  return !libelleFCIL;
};

export const shouldDisplayAjustement = (typeDemande: TypeDemandeType, user: UserType) => {
