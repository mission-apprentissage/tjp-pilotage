...
export const getMotifsRefusTypeDemande = (typeDemande: TypeDemandeType): MotifRefusLabel[] =>
...
const motifs: Partial<Record<TypeDemandeType, MotifRefusLabel[]>> = {
...
} satisfies { [key in TypeDemandeType]: MotifRefusLabel[] };
