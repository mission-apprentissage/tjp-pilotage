...
import type { Corrections } from "@/app/(wrapped)/demandes/corrections/types";
import type {
  AnneeCampagneMotifCorrection,
  MotifCorrectionLabel,
} from "@/app/(wrapped)/demandes/utils/motifCorrectionUtils";
import { getMotifCorrectionLabel } from "@/app/(wrapped)/demandes/utils/motifCorrectionUtils";
import type {
  AnneeCampagneRaisonCorrection,
  RaisonCorrectionLabel,
} from "@/app/(wrapped)/demandes/utils/raisonCorrectionUtils";
import { getRaisonCorrectionLabelParAnneeCampagne } from "@/app/(wrapped)/demandes/utils/raisonCorrectionUtils";
