...
export const CorrectionSection = ({
  ...
  const form = useForm<CorrectionFormType>({
    defaultValues: {
      ...
      libelleColoration1: demande.libelleColoration1,
      libelleColoration2: demande.libelleColoration2,
  ...
  const {
    ...
    onSuccess: (_body) => {
      push(getRoutingAccessSaisieDemande({user, campagne, suffix: `?campagne=${campagne?.annee}`}));
