...
import type { DemandesRestitutionIntentions, FiltersDemandesRestitutionIntentions } from "./types";

export const findDefaultRentreeScolaireForCampagne = (
  annee: string,
  rentreesScolaires: DemandesRestitutionIntentions["filters"]["rentreesScolaires"]
) => {
