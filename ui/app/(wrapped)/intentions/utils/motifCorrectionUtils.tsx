...
export type MotifCorrectionLabel =
  keyof (typeof MOTIFS_CORRECTION_LABELS)[MotifCorrectionCampagne];
...
export const MOTIFS_CORRECTION_LABELS = {
  "2023": {
    ...
    repartition_apprentissage_scolaire:
      "Nouvelle répartition apprentissage/scolaire",
