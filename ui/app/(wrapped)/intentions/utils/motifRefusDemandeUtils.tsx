...
export const getMotifRefusLabel = (motif: MotifRefusLabel): string =>
  MOTIFS_REFUS_LABELS[motif];

export const getMotifsRefus = () => motifs;
export const getMotifsRefusTypeDemande = (
  typeDemande: TypeDemande
): MotifRefusLabel[] => getMotifsRefus()[typeDemande];
...
export const MOTIFS_REFUS_LABELS = {
  ...
  correpond_pas_axes_prioritaires:
    "Ne correspond pas aux axes prioritaires fixés",
