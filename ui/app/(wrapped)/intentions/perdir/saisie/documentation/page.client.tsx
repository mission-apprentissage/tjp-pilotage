      ...
      <Container maxW="container.md" py={4}>
        <VStack spacing={8} align="stretch" mb={20}>
          ...
          <Alert status="warning" variant="subtle">
            <AlertIcon />
            Depuis le 23 novembre les experts et les pilotes ont les mêmes permissions dans Orion, il n'y a donc plus qu'un seul profil "Pilote Régional" pour ces utilisateurs
          </Alert>

          <Box>
            <Alert status="info" variant="subtle" mb={4}>
              En 2023, la saisie est effectuée par la région académique sur la période de concertation régionale : projets de demandes et demandes définitives.
            </Alert>
            <Image
            ...
            <Box as="blockquote" pl={4} borderLeft="4px" borderColor="blue.500" mb={4}>
              <Text>
                La saisie des "projets de demande" permet de donner de la visibilité à la DGESCO alors même que les discussions sont encore en cours au niveau régional.
              </Text>
            </Box>
            <Text mb={4}>
            ...
            <Text fontWeight="bold">
              A la fin du processus, les demandes définitives enregistrées dans Orion doivent correspondre à la liste des demandes proposées au vote du Conseil Régional
            </Text>
          </Box>
          ...
          <Box>
            ...
            <UnorderedList spacing={2} ml={12}>
              ...
              <ListItem>Modifier un projet de demande ou une demande définitive, y compris ceux qu'il n'a pas initiés</ListItem>
              ...
              <ListItem>Consulter toutes les demandes sur l'ensemble des régions dans la console de restitution</ListItem>
              <ListItem>Accéder aux indicateurs de pilotage de la transformation de la carte de l'ensemble des régions</ListItem>
            </UnorderedList>
          </Box>
          ...
          <Box>
            ...
            <UnorderedList spacing={2} ml={12}>
              ...
              <ListItem>Recherche simple d'un établissement par son nom et sa commune, par exemple "Gustave Eiffel Paris"</ListItem>
              <ListItem>Types de demandes prédéfinis : une consigne s'affiche pour rappeler le contexte de chaque demande</ListItem>
              <ListItem>Proposition d'une liste de motifs à cocher avec possibilité de préciser</ListItem>
              <ListItem>Saisie contextualisée et guidée des capacités selon qu'il s'agit d'une augmentation ou d'une fermeture, d'une formation mixte ou d'une coloration</ListItem>
            </UnorderedList>
          </Box>
          ...
          <Box>
            ...
            <Box mb={6}>
              ...
              <UnorderedList spacing={2} ml={12}>
                ...
                <ListItem>La rentrée scolaire considérée est bien l'entrée de l'ouverture de la 2nde commune sur l'établissement</ListItem>
              </UnorderedList>
            </Box>
            ...
            <Box>
              ...
              <UnorderedList spacing={2} ml={12}>
                <ListItem>Les demandes à enregistrer dans Orion concernent uniquement les colorations portant sur des ouvertures de places supplémentaires (augmentation de capacité ou ouverture de formation)</ListItem>
