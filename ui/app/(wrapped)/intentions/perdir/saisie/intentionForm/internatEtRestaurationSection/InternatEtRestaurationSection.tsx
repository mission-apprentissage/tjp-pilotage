  ...
  return (
    ...
    >
      ...
      <Flex gap="6" mb="6" direction={"column"}>
        ...
        <AugmentationCapaciteAccueilHebergementPlacesField
          disabled={disabled}
        />
        <AugmentationCapaciteAccueilHebergementPrecisionsField
          disabled={disabled}
        />
        <AugmentationCapaciteAccueilRestaurationField disabled={disabled} />
        <AugmentationCapaciteAccueilRestaurationPlacesField
          disabled={disabled}
        />
        <AugmentationCapaciteAccueilRestaurationPrecisionsField
          disabled={disabled}
        />
      </Flex>
    </Flex>
