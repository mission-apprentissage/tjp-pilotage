...
import type { Corrections, OrderCorrections } from "@/app/(wrapped)/intentions/corrections/types";
                ...
                return (
                  <Fragment key={`${correction.intentionNumero}`}>
                    <Tr
                      ...
                      role="group"
                      cursor={"pointer"}
                      onClick={() => router.push(`/intentions/saisie/${correction.intentionNumero}?correction=true`)}
                    >
                      <LineContent
