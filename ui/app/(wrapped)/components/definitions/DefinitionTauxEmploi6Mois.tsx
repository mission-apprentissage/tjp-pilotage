...
const DefinitionTauxEmploi6Mois = ({ label, millesime }: { label?: string; millesime?: string }) => (
...
const TooltipDefinitionTauxEmploi6Mois = ({ label, millesime }: { label?: string; millesime?: string }) => {
  const { openGlossaire } = useGlossaireContext();

  return (
    <TooltipIcon
      ml="1"
      label={<DefinitionTauxEmploi6Mois label={label} millesime={millesime}/>}
