  ...
  return (
    <Flex px={"56px"} py={"132px"} bgColor="grey.975">
      <Flex direction={"column"} gap={4} justifyContent={"center"} alignItems={"center"}>
        <Heading as="h3" fontSize={"20px"} fontWeight={"bold"} color="grey.625" textAlign={"center"}>
          Formation absente
        </Heading>
        <Text color="grey.625">
          Cette formation n'est pas enseignée dans le territoire choisi. Vous pouvez{" "}
          <Link
        ...
        <Img height="160px" src="/illustrations/loupe-recherche.svg" alt="Illustration d'une loupe" my={"auto"} />
      </Flex>
    </Flex>
  );
};
