...
export type TauxIJValues =
  (typeof client.infer)["[GET]/formation/:cfd/indicateurs"]["tauxIJ"]["tauxInsertion"];
export type TauxIJValue =
  (typeof client.infer)["[GET]/formation/:cfd/indicateurs"]["tauxIJ"]["tauxInsertion"][number];
export type TauxIJType =
  keyof (typeof client.infer)["[GET]/formation/:cfd/indicateurs"]["tauxIJ"];

export type TauxAttractiviteType = "tauxPression" | "tauxRemplissage";

export type TauxPressionValue =
  (typeof client.infer)["[GET]/formation/:cfd/indicateurs"]["tauxPressions"][number];

export type TauxRemplissageValue =
  (typeof client.infer)["[GET]/formation/:cfd/indicateurs"]["tauxRemplissages"][number];

export type FormationIndicateurs =
  (typeof client.infer)["[GET]/formation/:cfd/indicateurs"];
...
export type Etablissement =
  (typeof client.infer)["[GET]/formation/:cfd/map"]["etablissements"][number];
