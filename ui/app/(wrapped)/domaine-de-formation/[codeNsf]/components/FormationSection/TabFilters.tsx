  ...
  return (
    ...
    >
      <Flex gap={"16px"}>
        ...
        >
          <option value="">
            Présence sur le territoire: Tout ({formationsAllScopes})
          </option>
          <option value="dispensees">
            Uniquement celles dispensées sur le territoire ({formationsInScope})
          </option>
        ...
        >
          ...
          <option value="apprentissage">
            Apprentissage ({formationsApprentissage})
          </option>
        </Select>
      </Flex>
