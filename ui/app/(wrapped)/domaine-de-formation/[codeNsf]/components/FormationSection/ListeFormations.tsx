...
import { FormationListItem } from "../../types";

const LabelNumberOfFormations = ({
  formations,
}: {
  formations?: Array<FormationListItem>;
}) => (
  <Text>
            ...
            <ListItem key={codeNiveauDiplome} ms={3}>
              ...
              <List>
                {formattedFormations[codeNiveauDiplome]
                  .sort((a, z) =>
                    a.libelleFormation.localeCompare(z.libelleFormation)
                  )
                  .map((formation) => (
                    <ListItem
                      key={`${formation.cfd}`}
                    ...
                    >
                      ...
                      >
                        ...
                        <Flex direction="row" gap={1}>
                          <BadgeTypeFamille
                            typeFamille={
                              formation.typeFamille as TypeFamilleKeys
                            }
                          />
                        </Flex>
                      </Flex>
