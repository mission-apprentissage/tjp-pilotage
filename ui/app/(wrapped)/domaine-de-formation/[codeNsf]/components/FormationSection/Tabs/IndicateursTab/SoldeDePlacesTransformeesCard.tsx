...
import { DashboardCard } from "../../../../../../panorama/etablissement/components/DashboardCard";
import { FormationIndicateurs } from "../../../../types";
...
export const SoldeDePlacesTransformeesCard = ({
  scope,
  data,
}: {
  scope: Scope;
    ...
    >
      {displaySoldeDePlacesTransformees(data) ? (
        <SoldeDePlacesTransformeesGraph
          ...
          xAxisData={data.soldePlacesTransformee.map(
            (s) => `RS ${s.rentreeScolaire.toString()}`
          )}
        />
      ) : (
