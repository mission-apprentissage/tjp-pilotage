...
const displayTauxAttractivite = (data: FormationIndicateurs, tauxAttractiviteSelected: TauxAttractiviteType) => {
  return displayTauxAttractiviteDatas(getTauxAttractiviteDatas(data, tauxAttractiviteSelected));
};
