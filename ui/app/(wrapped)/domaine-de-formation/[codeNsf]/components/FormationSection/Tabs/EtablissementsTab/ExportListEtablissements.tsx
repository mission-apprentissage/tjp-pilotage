...
const extractDatas = (
  ...
  const { libelle: libelleEtablissement, commune, codeDepartement, ...restEtablissement } = etablissement;
...
const columns: ExportColumns<ReturnType<typeof extractDatas>> = {
  ...
  tauxEmploi: "Taux d'emploi à 6 mois",
  tauxDevenir: "Taux de devenir",
