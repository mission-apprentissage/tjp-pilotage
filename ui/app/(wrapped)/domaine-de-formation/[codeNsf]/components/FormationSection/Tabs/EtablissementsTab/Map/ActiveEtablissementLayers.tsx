...
export const ActiveEtablissementLayers = ({
  etablissements,
  hoverUai,
  setActiveUai,
}: {
  ...
  const activeEtablissement = etablissements.find((e) => e.uai === hoverUai);
  ...
  const etablissementPoint = {
    ...
    properties: {
      ...
      voies: [
        activeEtablissement?.isApprentissage ? "apprentissage" : "",
        activeEtablissement?.isScolaire ? "scolaire" : "",
      ]
        .filter(Boolean)
        .join(","),
    },
