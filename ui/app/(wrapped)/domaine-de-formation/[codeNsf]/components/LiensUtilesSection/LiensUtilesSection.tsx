...
export const LiensUtilesSection = ({ filters, scope }: { filters: Filters; scope: ScopeZone }) => {
  ...
  return (
    <Container maxW={"container.xl"} as="section">
      <Flex direction={"column"} gap={8} mt={8} maxW={"100%"} id={"liens-utiles"}>
        ...
        <Divider width="48px" />
        <Box>
          Les enjeux de demain pour mieux anticiper les formations insérantes : accédez ici à une multitude
          d'informations pour enrichir vos analyses.
        </Box>
