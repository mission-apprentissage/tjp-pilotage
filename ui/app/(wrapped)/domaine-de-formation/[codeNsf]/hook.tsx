...
export const useDomaineDeFormation = ({
  ...
  const [scope, setScope] = useState<Scope>(ScopeEnum.national);
  const [formations, setFormations] =
    useState<FormationListItem[]>(defaultFormations);
  ...
  const [filtersNumberOfFormations, setFiltersNumberOfFormations] =
    useState<FiltersNumberOfFormations>({
  ...
  useEffect(() => {
    setFormations(
      defaultFormations
        ...
        .filter((formation) =>
          currentFilters.voie === "scolaire" ? formation.scolaire : true
        )
    );
  ...
  useEffect(() => {
    ...
    const formationsByVoie = defaultFormations
      .filter((formation) =>
        currentFilters.voie === "apprentissage" ? formation.apprentissage : true
      )
      .filter((formation) =>
        currentFilters.voie === "scolaire" ? formation.scolaire : true
      );
