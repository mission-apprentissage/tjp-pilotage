    ...
    <Container maxWidth={"full"} px={0}>
      <VStack mt={16} mb={5} width="100%" backgroundColor={themeColors.grey[975]} color={themeColors.grey[625]} py={"132px"} px={"200px"}>
        ...
        <Text size="md" align={"center"} my={4}>
          ...
          Vous pouvez <b><a href="/pilotage-reforme" style={{ textDecoration: "underline" }}>consulter les données pour tous les diplômes</a></b> ou sélectionner un autre niveau de diplôme dans le filtre.
        </Text>
