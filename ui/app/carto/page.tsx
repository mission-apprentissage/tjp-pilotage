  ...
  return (
    <Flex height="100vh" width="100%" direction="column">
      ...
      <Box
        ...
        as="iframe"
        flex="1"
        src="https://public.tableau.com/views/BassindemploiouverturesfermeturesTopFAPs/Board?:embed=y&:showVizHome=no&:host_url=https%3A%2F%2Fpublic.tableau.com%2F&:embed_code_version=3&:toolbar=yes&:tabs=no&:animate_transition=yes&:display_static_image=no&:display_spinner=no&:display_overlay=yes&:display_count=yes&:language=fr-FR&:loadOrderID=0"
      />
    </Flex>
  );
};
