...
const StatsPilotageIntentionSchema = z.record(z.string(), StatsSchema);
...
export const getPilotageIntentionsSchema = {
  ...
  response: {
    200: z.object({
      domaines: StatsPilotageIntentionSchema,
      top10Domaines: StatsPilotageIntentionSchema,
      niveauxDiplome: StatsPilotageIntentionSchema,
      zonesGeographiques: StatsPilotageIntentionSchema,
      statuts: StatsPilotageIntentionSchema,
